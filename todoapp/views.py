...
def index(request):
    if request.method == "GET":
      ...
      try:
        ...
        return render(request, 'todoapp/index.html', {'error': 'You must select a user', 'users' : users, 'todos': todo})
      else:
        new_todo = Todo()
...
def signup(request):
    if request.method == 'GET':
      ...
      try:
        ...
        return render(request, 'todoapp/signup.html', {'error': 'Username or Email already exists'})
